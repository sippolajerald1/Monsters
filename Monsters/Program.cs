...
namespace Monsters
{
    ...
    class Program
    {
        ...
        static List<Monster> ReadFromFile()
        {
            List<Monster> monsters = new List<Monster>();
            {
                //
                ...
                foreach (string monster in monsterStrings)
                {
                    ...
                    // 
                    // create a new monster with property values
                    //
        ...
        static void DisplayFilterByAttitude(List<Monster> monsters)
        {
            ...
            //  filteredMonsters = monsters.where(m => m.Attitude).ToList();
            //    filteredMonsters = filteredMonsters.OrderedBy(mbox => mbox.Name.ToList();
        ...
        {
            DisplayScreenHeader("Write to the Data File");

            // prompt the user to proceed a or cancel
            DisplayContinuePrompt();
